...
public:
    ...
    struct hunter_botAI : public bot_ai
    {
        ...
        void EnterCombat(Unit* u) { aspectTimer = 0; bot_ai::EnterCombat(u); }
        ...
        void JustDied(Unit* u) { Aspect = 0; UnsummonAll(); bot_ai::JustDied(u); }
...
//                (!botPet || me->GetDistance2d(botPet) > sWorld->GetMaxVisibleDistanceOnContinents()))
        ...
        void ApplyClassEffectMods(SpellInfo const* spellInfo, uint8 effIndex, float& value) const
        {
            uint32 baseId = spellInfo->GetFirstRankSpell()->Id;
            float pctbonus = 1.0f;
        ...
        void OnBotDamageDealt(Unit* victim, uint32 damage, CleanDamage const* cleanDamage, DamageEffectType damagetype, SpellInfo const* /*spellInfo*/)
        {
